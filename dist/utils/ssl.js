...
exports.loadSSLCredentials = loadSSLCredentials;
/**
...
function loadSSLCredentials() {
    ...
    const keyPath = path_1.default.join(PROJECT_ROOT, '.ssl/server.key');
    const certPath = path_1.default.join(PROJECT_ROOT, '.ssl/server.crt');
    ...
    try {
        ...
        const certificate = fs_1.default.readFileSync(certPath, 'utf8');
